...
import { createCourses } from "../../../reducers/actions/courseSlice";
...
const Add = () => {
	...
	const handleSubmit = async(e) => {
		e.preventDefault();
    const result = await dispacth(createCourses({data: {...form, company_id: companyId}}))
		if (result.meta.requestStatus === "fulfilled") {
			Swal.fire({
				position: "center",
				icon: "success",
				title: "Course has been add!",
